...
public class D_PatientList extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_d__patient_list);

        BottomNavigationView bottomNavigationView = (BottomNavigationView) findViewById(R.id.doctorNavigation);
        bottomNavigationView.setSelectedItemId(R.id.D_PatientList);
